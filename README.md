...
hashtag and then the ID attribute value we want to match.
...
The adjacent sibling selector targets elements that appear directly after the
matching selector name. We indicate it using a plus symbol.
